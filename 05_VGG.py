...
def main():
    ...
    pascal_classifier = tf.estimator.Estimator(
        ...
        model_dir="./tmp/pascal_vgg16_finetune_04",
        config = tf.estimator.RunConfig(model_dir = "./tmp/pascal_vgg16_finetune_04", 
        save_summary_steps=100, save_checkpoints_steps = 500)) 
    ...
    #Np_pool5_VGG_task5 = TemporaryFile()
    #Np_fc7_VGG_task5 = TemporaryFile()

    np.save('Np_pool5_VGG_task5',features_pool5)
    np.save('Np_fc7_VGG_task5',features_fc7)

    #np.savetxt('Tx_pool5_VGG_task5.txt', features_pool5)
    #np.savetxt('Tx_fc7_VGG_task5.txt', features_fc7)




    #writer = tf.summary.FileWriter("./tmp/pascal_vgg16_finetune_04")
