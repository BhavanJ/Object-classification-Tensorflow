...
#Updated version, includes numpy conv1 filter data generation for task 5 as well
...
def main():
    ...
    pascal_classifier = tf.estimator.Estimator(
        ...
        model_dir="./tmp/02_pascal_alexnet_updated_task5")
    ...
    writer = tf.summary.FileWriter("./tmp/02_pascal_alexnet_updated_task5")
    ...
    for ii in range(40):
        ...
        if(ii==1 or ii==19 or ii==29 or ii==39):
            conv1_weights = pascal_classifier.get_variable_value('conv2d/kernel')
            np.save('Conv1_weight_'+str(ii),conv1_weights)
